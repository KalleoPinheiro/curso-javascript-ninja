...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Kalléo Pinheiro'
...
pessoa.apresentacao = function(){
  var artigoDoGenero = pessoa.sexo = 'masculino' ? 'o' : 'a';
  var anos = pessoa.idade > 1 ? 'anos' : 'ano';
  var metros = pessoa.caminhouQuantosMetros > 1 ? 'metros' : 'metro';
  return 'Olá, eu sou ' + artigoDoGenero + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' ' + anos + ', ' + pessoa.altura +', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros + ' ' + metros + '!'
}
