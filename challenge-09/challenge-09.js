...
*/
  ...
  */
  var sum = calculator(1, 15);
  var subtraction = calculator(25, 15);
  var multiplication = calculator(25, 15);
  var division = calculator(350, 20);
  var mod = calculator(15, 5);
  ...
  */
  var sum = sum(function (number1, number2) {
    return number1 + number2;
  })
  ...
  */
  ...
  chamada.
  */
  var subtraction = subtraction(function (number1, number2) {
    return number1 - number2;
  });
  console.log('O resultado da subtração é: ', subtraction);

  var multiplication = multiplication(function (number1, number2) {
    return number1 * number2;
  });
  console.log('O resultado da multiplicação é:', multiplication);

  var division = division(function (number1, number2) {
    return number1 / number2;
  });
  console.log('O resultado da divisão é:', division);

  var mod = mod(function (number1, number2) {
    return number1 % number2;
  });
