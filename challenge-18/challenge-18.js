...
*/
  ...
  */
  ...
  function cleanCPF(cpf) {
    return cpf.replace(/\D/g, "").toString();
  }
  ...
  */
  ...
  console.log(cleanCPF("210.458.522-05").replace(regex, "$1.$2.$3-$4"));
  /*
  ...
  */
  ...
  const regexExp = /ju[nl]ho/g;
  console.log(
    "Os meses de janeiro, junho e julho começam com a letra j.".match(regexExp)
  );
  ...
  */
  ...
  const rg = /\<\w+\>\<\/\w+\>/g;
  console.log(
    "<div><ul><li></li><li></li><li><span></span></li></ul></div>".match(rg)
  );
  ...
  */
  ...
  console.log(
    text.replace(tagRegex, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n')
  );
})();
