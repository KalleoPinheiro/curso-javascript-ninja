((win, doc) => {
  ...
  */
  let $username = prompt(`Qual o seu nome?`) || ($username = 'Desconhecido...');
  ...
  */
  let $email = prompt(`Qual o seu email?`) || ($email = 'Não informado...');
  ...
  */
  ...
  function isValidEmail(email) {
    const emailRegex = new RegExp('^[\\w+.]+@\\w+\\.\\w{2,}(?:\\.\\w{2})?$', 'g');
