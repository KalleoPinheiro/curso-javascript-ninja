(() => {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Kalléo Pinheiro'));
  /*
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, (arg1) => {
  ...
  */
  ...
  function getMonthNumber(month) {
    ...
    return (months.indexOf(month) + 1).toString().length != 1 ?
  ...
  */
  ...
  const regexDate = /(\d\d) \w\w (\w*?) \w\w (\d\d\d\d)/g;
  ...
  */
  ...
  function replaceDate(date) {
    return date.replace(regexDate, (matches, arg1, arg2, arg3, quantity) => {
      return `${arg1}/${getMonthNumber(arg2)}/${arg3}`;
    });
  }

  console.log(text.replace(regexDate, function () {
    return replaceDate(arguments[0]);
  }));
