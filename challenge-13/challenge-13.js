...
*/
var nordeste = ['Bahia', 'Ceará', 'Pernambuco', 'Sergipe', 'Piauí', 'Alagoas', 'Paraíba', 'Rio Grande do Norte', 'Maranhão']
...
temCeara = brasil.some(function(item){
    return (item === 'Ceará')
})
console.log(temCeara ? 'Ceará está incluso' : 'Ceará não foi incluído :(')
